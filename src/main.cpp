...
public:
  ...
  void render(GLFWwindow *window, GLuint inputColorTexture,
...
int main(int, char **) {
  ...
  GLFWwindow *window =
      glfwCreateWindow(display_w, display_h, "Wormhole", nullptr, nullptr);
  if (window == nullptr)
    return 1;
  ...
  if (0) {
    ...
    // for the GL error. (enable together with GL_DEBUG_OUTPUT !)
  ...
  while (!glfwWindowShouldClose(window)) {
...

    {
      ...
      IMGUI_TOGGLE(mouseControl, false);
    ...
    passthrough.render(window, texTonemapped);
